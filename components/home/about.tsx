...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        We Are Digital Trailblazers, A Tech-Focused Company Offering Diverse {" "}
      </span>
      <span
      ...
      >
         Software Solutions, Including AI, Blockchain, Web Apps, Games, and Social Media Marketing.
      </span>
      <br/>
      <span
        className={`about-3 leading-tight text-red-500 ${
          willChange ? "will-change-opacity" : ""
        }`}
      >
         We believe in your growth, as we firmly believe that "We Grow Together".
      </span>
    </h1>
