...
const QuoteSection = () => {
  ...
  const renderQuote = (): React.ReactNode => (
    <div className="tall:py-60 py-72 section-container">
      <h1
        ref={quoteRef}
        className={`font-medium text-4xl md:text-5xl text-center capitalize ${
          willChange ? "will-change-opacity" : ""
        }`}
      >
        We have a strong <span className="text-strong font-bold px-2">obsession</span>
         to bring innovation in tech.
      </h1>
    </div>
  );
