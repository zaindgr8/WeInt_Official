...
const ProjectsSection = ({ isDesktop }: IDesktop) => {
  ...
  const renderSectionTitle = (): React.ReactNode => (
    ...
    >
      ...
      <h1 className="section-heading seq mt-2">Achievements</h1>
      <p className="lg:text-2xl md:text-lg sm:text:md md:max-w-3xl w-full seq max-w-sm mt-2 capitalize">
      We've collaborated with Global Companies from Dubai, UK, Netherlands providing Digital marketing, software solutions, and more.
      </p>
    </div>
  );
